...
<div class="courses">
<div class="course-poc">
  <!-- <img class="courses-img1" src="<?php bloginfo('stylesheet_directory'); ?>/images/POC Long.jpg" alt=""> -->
  <p class="intro-poc">
  ...
  <p class="preview-poc">
    <strong><em>For a
      <span class="upper">free preview</span>
...
<span class="fb-buffer space-bottom-plain"><span class="space5"></span></span>
  ...
  <p class="facebook-life">Visit our <a class="md-lg" href="https://www.facebook.com/pg/powerofconnectionbozemanmontana/events/?ref=page_internal" target="_blank">Facebook Page</a> to see when the next course is.</p>

</div>

<span class="fb-buffer-2">
...
<iframe class="poc-vid" width="840" height="472.5" src="https://www.youtube.com/embed/vHOz2l4B_Js" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
