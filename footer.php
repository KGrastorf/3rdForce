...
?>
	...
	<footer id="colophon" class="site-footer">
		<div class="site-info">
			...
			<p class="footer-name">3rd Force Communication Coaching and Consulting</p>
			<span class="sep"> | </span>
			<p class="footer-rights">&copy;2018 All Rights Reserved</p>
			<div class="footer-space-top"></div>
			<div class="footer-space-bottom"></div>
		</div><!-- .site-info -->
	</footer><!-- #colophon -->
</div><!-- #page -->
